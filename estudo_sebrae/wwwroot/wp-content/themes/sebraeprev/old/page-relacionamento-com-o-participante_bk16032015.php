...
if ($_POST) {
    ...
    if (!isset($hasError)) {
        ...
        //$emailTo = "allan.less@outlook.com";
	...
	<div id="form-faleconosco">
		<form action="<?php bloginfo('url'); ?>/relacionamento-com-o-participante/#tab2" method="post" class="clear contact_left">
            ...
            <div id="comment-input">
                ...
                <input type="text" name="cpf" id="cpf" value="<?php echo $_POST['cpf']; ?>" placeholder="CPF (obrigatório)" size="22" tabindex="2" aria-required="true" class="input-email" onblur="javascript:somente_numero2(this);" onKeyUp="javascript:somente_numero(this);">
