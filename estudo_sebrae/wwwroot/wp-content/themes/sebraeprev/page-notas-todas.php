<?php get_header('single');?>
	...
	<div id="main" class="" style="overflow:hidden !important;">
		...
		<div id="content" style="float:left;">
				...
				<p><a><img class="size-full wp-image-1079 alignleft" alt="seta-azul" src="http://sebraeprevidencia.com.br/wp-content/uploads/2013/07/seta-azul1.png" width="22" height="44" /></a><div class="title"><h2>Notas Quinzenais</h2><div class="title-sep-container"><div class="title-sep"></div></div></div>
<div class="avada-container">
	<section class="columns columns-1" style="width:100%">
		<div class="holder">
			<?php
				$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
				$args = array('posts_per_page' => 5, 'post_type' => 'notas' ,'paged' => $paged );
				query_posts($args);
