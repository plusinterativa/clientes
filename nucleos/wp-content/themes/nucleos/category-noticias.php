    ...
    <main class="main_wrap container">
        <div class="content">
            ...
            <section class="main_publications">
                <h1 class="section_title">Notícias</h1>
                <?php
                    while ( have_posts() ):
                        the_post();
                ?>
                    <div class="main_links main_article">
                        <a href="<?php the_permalink(); ?>" rel="nofollow" title="Visitar o site" target="_blank">
                            <?php the_post_thumbnail( 'tamanho-thumbnail' ); ?>
                        </a>
                        <p class="main_link_site">
                            <a href="<?php the_permalink(); ?>" rel="nofollow" title="" title=""><?php the_title(); ?></a>
                        </p>
                        <div class="clear"></div>
                    </div>
                <?php endwhile; ?>
