<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />   	
        ...
        <?php
			...
			if (isset($_POST['edit'])) {
				...
				if (!empty($_POST['titulo']) and !empty($_POST['noticia']) and !empty($_POST['fonte']) and !empty($_POST['cod'])) {
					...
					if (!empty($banner["name"])) {
						...
						$sql = "UPDATE noticias SET titulo='$titulo',noticia='$noticia',fonte='$fonte',post='$post',foto='$caminho_imagem2' WHERE id='".$cod."'";
						...
						echo '")
							...
							$sql = "UPDATE noticias SET titulo='$titulo',noticia='$noticia',fonte='$fonte',post='$post' WHERE id='".$cod."'";
...
location.href=("../sistema.php?menu='.base64_encode('Notícias').'&acao=edit&cod='.$_POST['cod'].'")				
