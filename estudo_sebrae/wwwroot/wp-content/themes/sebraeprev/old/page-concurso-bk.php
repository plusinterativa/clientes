		...
		if ( isset( $_POST["recaptcha_response_field"] ) ) {
			...
			if ( $resp->is_valid ) {
				if( isset($_POST) && isset($_POST['enquete']) ) {
					...
					if( $resultado === true ) {
						$resultado = "Seu voto foi cadastrado com sucesso!";
						$chart = true;
					} else {
						$resultado = "Seu voto não foi cadastrado. Por favor, tente novamente.";
					}
				} else {
					$resultado = "Por favor, selecione uma opção";
				}
			} else {
	            $resultado = "Por favor, informe os caracteres novamente.";
	        }
	    }
	} else {
		$resultado = "Tentativa por robo!";
	}
