...
if ($_POST) {
    ...
    if (!isset($hasError)) {
        ...
        //$emailTo = "prevsebrae@gmail.com";
        


        //$emailTo = "arthur.uchoa@plusinterativa.com";
        //$body = "Name: $name \n\nEmail: $email \n\nTelefone: $telefone \n\nSubject: $subject \n\nComments:\n $comments";
...
jQuery(window).load(function() {
    ...
    <div id="form-faleconosco">
        ...
        if (count($matches)>1):
            ...
            if($version<=8):
        ?>
            <div style="float: left;width: 60%;" class="mensagem-browser">
                <style type="text/css">
                #form-faleconosco form{ display: none;}
                </style>
                A versão do seu navegador não suporta o formulário de contato.<br/>
                Por favor, atualize o seu <a href="http://windows.microsoft.com/pt-br/internet-explorer/download-ie" style="text-decoration:underline;" target="_blank">Internet Explorer</a> ou, se preferir, baixe o navegador <a href="https://www.google.com/chrome" style="text-decoration:underline;" target="_blank">Google Chrome</a> clicando aqui.
            </div>
        <?php
            endif;
        endif;
		...
		<form action="<?php bloginfo('url'); ?>/relacionamento-com-o-participante/#tab2" method="post" class="clear contact_left">
            ...
            <?php if (isset($emailSent1) && $emailSent1 == true) { ?>
                <div class="alert success"><div class="msg"><strong><?php echo strtoupper($name); ?></strong><?php echo __(', obrigado por entrar em contato! Sua mensagem foi enviada com sucesso e será retornada em até 48h. <br />(Obs: O prazo considera os dias úteis e as mensagens enviadas até as 18h).', 'Avada'); ?></div></div>
                <br />
            <?php } ?>

            <div id="comment-input">
                <input type="text" name="contact_name" id="author" value="<?php echo $_POST['contact_name']; ?>" placeholder="Nome (obrigatório)" size="22" tabindex="1" aria-required="true" class="input-name" onblur="javascript:nao_numeros(this);" onKeyUp="javascript:nao_numeros(this);">
                <?php 
                    $estados = array(
					    "AB - Abase"=>"Abase",
                        "AC"=>"Acre",
...
<p>(61) 3327-1226<br />
	...
	<div id="form-agendamento">
        ...
        ?>
            <div style="float: left;width: 60%;" class="mensagem-browser">
                <style type="text/css">
                #form-agendamento form{ display: none;}
                </style>
                A versão do seu navegador não suporta o formulário de contato.<br/>
                Por favor, atualize o seu <a href="http://windows.microsoft.com/pt-br/internet-explorer/download-ie" style="text-decoration:underline;" target="_blank">Internet Explorer</a> ou, se preferir, baixe o navegador <a href="https://www.google.com/chrome" style="text-decoration:underline;" target="_blank">Google Chrome</a> clicando aqui.
            </div>
