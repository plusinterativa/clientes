...
?>
                    <input type="submit" value="ACESSAR A ÁREA RESTRITA" style="background:#c7c7c7;" onclick="window.open(this.getAttribute('http://177.159.151.250/sebraenovaweb/Login.aspx'), '_blank');" /> | </div>
                    <div class="aligright">
