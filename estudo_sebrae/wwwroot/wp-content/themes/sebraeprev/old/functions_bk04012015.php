...
add_image_size('tamanho-noticias-home', 560, 340, true);
...
/*
*  Função para alterar a largura e altura do iframe do video, para utilizar o mesmo link
*  @author Vlamir Santo em 28/08/2014
*/
function the_videos($video, $width, $height)
{
    $url = '<iframe width="'. $width .'" height="'. $height .'" src="'. $video .'" frameborder="0" allowfullscreen></iframe>';
    echo $url;
}
