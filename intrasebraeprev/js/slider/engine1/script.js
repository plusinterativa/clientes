...
jQuery("#wowslider-container1").wowSlider({effect:"basic",prev:"<",next:">",duration:100*100,delay:50*100,outWidth:920,outHeight:400,width:920,height:400,autoPlay:true,stopOnHover:true,loop:true,bullets:true,caption:true,controls:true});