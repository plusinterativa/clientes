...
<div class="seta-azul-esq">                         
<!--seta azul-->
                        <img width="22" height="44" src="http://anaphab.com.br/sebraeprev/wp-content/uploads/2013/07/seta-azul.png"                  alt="">
<span class="titulo-seta-azul">Publicações</span>
<!--seta azul-->
</div>
<div class="seta-azul-dir">
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
			...
			<div class="project-content">
				<div class="project-description post-content">
					<h3><?php the_title(); ?><?php/* echo __('Project Description', 'Avada') */?></h3>
					<?php the_content(); ?>
				</div>
