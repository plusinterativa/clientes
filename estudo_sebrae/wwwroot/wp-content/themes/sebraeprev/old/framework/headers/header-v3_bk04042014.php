...
if (!$boolLogado) {
    ?>
                    ...
                    <form name="form1" id="form-integracao" method="post" action="<?php echo($location); ?>" onsubmit="return carregaSenha();">
                        ...
                        <input type="submit" id="logar" name="bt" value="Entrar" style="background:#c7c7c7;" />
                    </form>
                    ...
                    <font color="#ffffff">Ol&aacute;, <b><?php echo($_COOKIE[md5("logaNome")]); ?></font></b>
                    ...
                    &nbsp;|&nbsp;<a href="<?php echo($location); ?>?logoff=true"><span><font color="#ffffff">[Sair do Sistema]</font></span></a>
