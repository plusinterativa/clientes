<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <table class="formUpload">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <tr>
            	...
            	<td colspan="2">
                	...
                	<h3 style="background:#eee;color:#333;border-top:2px dotted #ddd;border-bottom:2px dotted #ddd;width:860px;"> Deixe seu Comentario: </h3>
            ...
            <tr>
                ...
                <td colspan="2">
                	...
                	<textarea name="comentario" style="width:100%;" value="<?php if(isset($_POST['comentario'])) { echo $_POST['comentario']; } ?>"></textarea>
        ...
        <?php include("php/cadComentarios.php"); ?>